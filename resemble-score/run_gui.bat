...
echo(
echo  ============================================================
echo   resemble-score  --  Deepfake Scoring GUI
echo  ============================================================
...
set "STAMP_KEY=%STAMP_KEY::=-%"
set "STAMP_FILE=%STATE_DIR%\resemble_gui_%STAMP_KEY:~0,60%.ok"

set "NEED_PIP=1"
if exist "!STAMP_FILE!" (
  "!PYTHON_BIN!" -c "import requests, rich; import tkinter" >nul 2>&1
...
if "!NEED_PIP!"=="0" (
  ...
  for %%F in ("%STATE_DIR%\resemble_gui_*.ok") do del "%%F" >nul 2>&1
