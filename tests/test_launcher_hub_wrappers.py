...
def test_launcher_hub_wrappers_delegate_targets():
    wrappers = {
        ...
        "launchers/windows/run_oldcam.bat": r'call "%ROOT_DIR%\launchers\windows\run_oldcam_v8.bat" %*',
        ...
        "launchers/macos/run_oldcam.command": 'exec "$ROOT_DIR/launchers/macos/run_oldcam_v8.command" "$@"',
