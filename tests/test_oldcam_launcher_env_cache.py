...
def test_run_oldcam_defaults_to_v13_via_launcher_chain():
    # run_oldcam.bat is a thin wrapper that chains through launchers/windows/run_oldcam_v13.bat
    # (which in turn delegates to oldcam-v13/oldcam_launcher.bat)
    text = (REPO_ROOT / "run_oldcam.bat").read_text(encoding="utf-8")
    assert "run_oldcam_v13.bat" in text
