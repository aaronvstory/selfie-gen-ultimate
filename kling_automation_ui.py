...
class KlingAutomationUI:
    ...
    def _automation_status_lines(self) -> List[str]:
        ...
        lines = [
            ...
            f"oldcam version={self.config.get('automation_oldcam_version', 'v13')} required={self.config.get('automation_oldcam_required', False)} readiness={self._oldcam_readiness_status()}",
    ...
    def _apply_recommended_automation_defaults(self) -> None:
        before = {
            ...
            "oldcam": (self.config.get("automation_oldcam_version", "v13"), self.config.get("automation_oldcam_required", False)),
    ...
    def _edit_automation_settings(self):
        ...
        _ask_choice("Oldcam version", "automation_oldcam_version", ["v7", "v8", "v9", "v10", "v11", "v12", "v13", "all"])
