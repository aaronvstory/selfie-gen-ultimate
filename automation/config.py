...
AUTOMATION_DEFAULTS: Dict[str, Any] = {
    ...
    "automation_front_expand_mode": "percent",  # document_3x4 | percent | percent_fullres | three_four_fullres
    ...
    "automation_selfie_expand_mode": "percent",  # percent | centered_3x4 | percent_fullres | three_four_fullres
