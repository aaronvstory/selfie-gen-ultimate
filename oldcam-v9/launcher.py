#!/usr/bin/env python3
"""Cross-platform launcher for Oldcam V9 inside the Creative Suite."""
...
def choose_files() -> list[str]:
    ...
    try:
        selected = filedialog.askopenfilenames(
            title="Select media files for Oldcam V9",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Launch Oldcam V9 with a file picker when no input files are provided."
    )
